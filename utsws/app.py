# 6C - 19090131 - MUWAFIQ AGUNG PRASTIO 
# 6C - 19090065 - ANDINI DWI AMBARWATI
# 6C - 19090116 - FEBI FAIZAL HUSENI
...
database_file = "sqlite:///{}".format(os.path.join(project_dir, "WS2.db"))
app=Flask(__name__)
